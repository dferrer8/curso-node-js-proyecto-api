...
describe('Usuarios', () => {
  describe('POST /users', () => {
    it('Debería crear un nuevo usuario', done => { // asincrono hasta que no este funcion done (mandada mocha si hay error enviamos el error y si no done)
      ...
      request(app)
        ...
        .expect(201)
        .expect(res => {
          expect(res.headers['x-auth']).to.exist // incorpora esta linea en el primer test
